...
class Page
{
	...
	static function fb_article_share($link,$fbdescr,$fbtitle,$pic)
	{
		$qt="'";
		$link="https://www.facebook.com/v2.4/dialog/feed";
		$link.="?app_id=828060457301904";
		$link.="&caption=".Page::fbChop($fbtitle);
	...
	static function clean_text($s)
	{
		...
		$ret=str_replace ('"',"~2",$ret);
		 return  str_replace(chr(13).chr(10),"~3",$ret);
	}
	static function unclean_text($s)
	{
		$ret=str_replace ("~1","&lsquo;",$s);
		$ret=str_replace ("~2","&quot;",$ret);
		return str_replace("~3",chr(13).chr(10),$ret);
	}
	...
	static function fmt_page($t,$artid,$hdg,$screentype)
	{
		...
		//facebook feed
		$ret.=Page::fb_article_share("http://www.chorltonlittlegems.co.uk/ed",$hdg,$ret,
		"http://www.chorltonlittlegems.co.u	k/ed/".$imgToPost);
		$ret.="</td>
		</tr>
		</table>";
		$ret.="<br/>";
	...
	static function fmt($s,$col,$font,$fontsize,$fontweight,$italic="N",$ul="N")
	{
